...
render() {
  return (
    ...
    <div className="col-md-5"><input className="Input-Box Card-Input" onChange={this.handleChange.bind(this, this.props.index, 'term')} value={this.props.term}  ref="term" id="term" type="text" placeholder="Enter term"/><br/><label className="Input-Label">TERM</label></div>
...
<a href="#"className="Card-Input-Buttons" onClick={()=>{this.state.showImageUpload = !this.state.showImageUpload}} > &#128247;</a>
    <br/><label className="Input-Label">DEFINITION</label></div>
    </div>
    {
